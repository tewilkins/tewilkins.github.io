...
Fortunately, it is avoided quite easily if your workflow incorporates some basic data hygiene practices.
...
But realistically you'll need secure workflow for the rest of your working life if you want to Now is the time to start getting it right.
\n

I'm going to be working with three domains in this guide: Rstudio, GitHub and Zotero.
These are all open-source and free-to-use for non-commercial purposes.
